import 'package:Online_Book_Shop/Contact_Chat.dart';
                                ...
                                children: [
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            "HOLY-QURAN Latest Version,Luxurious Leather Cover,Fresh Edition with New Pages,Publisher's Service Guarantee",
                                            style: TextStyle(
                                              color:
                                                  Color.fromRGBO(0, 48, 52, 1),
                                              letterSpacing: .1,
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.fromLTRB(
                                                0, 10, 0, 10),
                                            child: Text(
                                              "ADDITIONAL HOLY-QURAN INFORMATION:",
                                              style: TextStyle(
