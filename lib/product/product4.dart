                                ...
                                children: [
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            "ENVIRONMENT AND ECOLOGY OLD Version,Luxurious Leather Cover,Fresh Edition with New Pages,Publisher's Service Guarantee",
                                            style: TextStyle(
                                              color:
                                              Color.fromRGBO(0, 48, 52, 1),
                                              letterSpacing: .1,
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.fromLTRB(
                                                0, 10, 0, 10),
                                            child: Text(
                                              "ADDITIONAL ENVIRONMENT AND ECOLOGY INFORMATION:",
                                              style: TextStyle(
                                          ...
                                          Text(
                                            "Type of Book: ENVIRONMENTAL SCIENCES",
                                            style: TextStyle(
                                              color:
                                              Color.fromRGBO(0, 48, 52, 1),
                                              letterSpacing: .1,
